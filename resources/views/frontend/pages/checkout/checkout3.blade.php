            ...
            <div class="row">
                                                ...
                                                <form action="#" method="post">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="cardNumber" placeholder="card number" value="" required>
                                    ...
                                    <div class="panel-heading" role="tab" id="five">
                                        <h6 class="panel-title">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck2"> <i class="icofont-file-document"></i> Cash On Delivery</label>
                                            </div>
                                        </h6>
                                    </div>
                ...
                <div class="col-12">
                    <div class="checkout_pagination d-flex justify-content-end mt-30">
                        ...
                        <button type="submit" class="btn btn-primary mt-2 ml-2">Next Step</button>
                    </div>
                </div>
            </div>
        </form>
