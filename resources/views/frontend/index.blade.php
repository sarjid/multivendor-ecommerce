...
@section('content')
     <!-- Welcome Slides Area -->
@if ($banners->isEmpty())
    <Strong class="text-danger">Banner Not Found</Strong>
@else
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-5 col-md-4">
                            <div class="welcome_slide_image">
                                <img src="{{ asset($banner->photo) }}" alt="" data-animation="bounceInUp" data-delay="500ms">
...
@endif
    ...
    <div class="top_catagory_area mt-50 clearfix">
        ...
        @if ($categories->isEmpty())
            <strong class="text-danger">Category Not Found</strong>
        @else
                <!-- Single Catagory -->
                    ...
                    <div class="col-12">
                        ...
                        @foreach ($allCategories as $cat)
                            <div class="single_catagory_slide">
                                <a href="{{ route('product.category',$cat->slug) }}">
                                    <img src="{{ $cat->photo }}" alt="{{ $cat->slug }}">
                                </a>
                                <p>{{ $cat->title }}</p>
                            </div>
                        @endforeach
                        ...
                        @foreach ($newProducts as $nproduct)
                            <div class="single-product-area">
                                <div class="product_image">
                                    ...
                                    @endphp
                                    @if (count($photo) == 1)
                                        <img class="normal_img" src="{{ $nproduct->photo }}" alt="">
                                        <img class="hover_img" src="{{ $nproduct->photo }}" alt="">
                                    @else
                                    ...
                                    <div class="product_wishlist">
                                        <a href="javascript::void(0)" class="add_to_wishlist" id="add_to_wishlist_{{ $nproduct->id }}" data-qty="1" data-id="{{ $nproduct->id }}"><i class="icofont-heart"></i></a>
                                    </div>
                                ...
                                <div class="product_description">
                                    ...
                                    <p class="brand_name">
                                        {{ App\Models\Brand::where('id',$nproduct->brand_id)->value('title') }}
                                    </p>
