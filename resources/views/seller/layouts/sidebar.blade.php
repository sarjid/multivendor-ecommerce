<div id="left-sidebar" class="sidebar">
    <div class="sidebar-scroll">
        ...
        @endif
            <div class="dropdown">
                <span>Welcome,</span>
                <a href="{{ route('seller') }}" class="user-name" ><strong>{{ auth('seller')->user()->username }}</strong>
                @if (auth('seller')->user()->is_verified)
                   <i class="fa fa-check-circle text-success" title="Verified"></i>
                @else
                    <span class="badge badge-pill badge-danger" title="Unverified">Unverified <i class="fa fa-times-circle text-danger"></i></span>
                @endif
                </a>
            </div>
            ...
            <div class="tab-pane active" id="menu">
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li class="{{ \Request::is('seller/seller-product*') ? 'active':'' }}">
                            <a href="javascript::void(0)" class="has-arrow"><i class="icon-briefcase"></i>
                                <span>Products Management</span>
                            </a>
                            <ul>
                                <li class="{{ Request::is('seller/seller*') ? 'active':'' }}">
                                    <a href="{{ route('seller-product.index') }}">All Products</a>
                                </li>
                                <li class="{{ Request::is('seller/seller-product/create') ? 'active':'' }}">
