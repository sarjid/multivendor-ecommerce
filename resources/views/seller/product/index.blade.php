            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        ...
                        <a href="{{ route('seller-product.create') }}"  class="btn btn-success" style="float: right;"><i class="fa fa-plus-circle"></i> Create New</a>
                        <h2>All products</h2>
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('seller-product.edit',$item->id) }}" data-toggle="tooltip" data-placement="bottom"  title="edit" class="btn btn-outline-warning"> <i class="icon-pencil"></i>
                                            </a>
