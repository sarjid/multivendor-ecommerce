                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $currency->name }}" placeholder="Enter currency name" />
                                </div>
                                @error('name')
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="symbol" value="{{ $currency->symbol }}" placeholder="Enter currency symbol" />
                                </div>
                                @error('symbol')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="exchange_rate" value="{{ $currency->exchange_rate }}" placeholder="Enter currency exchange_rate" />
                                </div>
                                @error('exchange_rate')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="code" value="{{ $currency->code }}" placeholder="Enter currency code" />
                                </div>
                                @error('code')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
