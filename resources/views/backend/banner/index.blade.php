    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <a href="{{ route('banner.create') }}"  class="btn btn-success" style="float: right;">Add New</a>
                        <h2>All Banner</h2>
                    </div>
                    <div class="body">
                                ...
                                @foreach ($banners as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge badge-pill badge-warning">{{ $item->condition }}</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('banner.edit',$item->id) }}" data-toggle="tooltip" data-placement="bottom"  title="edit" class="btn btn-outline-primary"> <i class="icon-pencil"></i>
                                            </a>
