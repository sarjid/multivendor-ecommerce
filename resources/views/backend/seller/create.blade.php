                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Enter seller title" />
                                </div>
                                @error('title')
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <select id="condition" name="condition" class="form-control show-tick">
                                    <option value="seller" {{ old('condition') =='seller' ? "selected" :'' }}>seller</option>
