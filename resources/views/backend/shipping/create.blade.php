...
@section('create-shipping') active @endsection
            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">shipping Create</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="shipping_address" value="{{ old('shipping_address') }}" placeholder="Enter shipping address" />
                                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="delivery_time" value="{{ old('delivery_time') }}" placeholder="Enter delivery time" />
                                </div>
                                @error('delivery_time')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="delivery_charge" value="{{ old('delivery_charge') }}" placeholder="Enter delivery charge" />
                                </div>
